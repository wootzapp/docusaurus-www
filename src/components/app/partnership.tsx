		...
		<section className='bg-brand-neutral-100 py-24 text-brand-base' id='delivery-formats'>
			<div className='container-custom flex flex-col gap-12'>
				...
				<div className='grid gap-8 md:grid-cols-2 lg:grid-cols-4'>
					<div className='flex flex-col gap-4 rounded-2xl border border-brand-neutral-300 bg-white p-6 shadow-sm'>
						<h3 className='font-matter text-lg font-semibold text-brand-base'>Create Browser-Use RL Environments</h3>
						<p className='text-sm text-brand-base/80'>
							Transform apps like Jira, Salesforce, or Confluence into structured browser-use training environments for agent learning.
						</p>
					</div>

					<div className='flex flex-col gap-4 rounded-2xl border border-brand-neutral-300 bg-white p-6 shadow-sm'>
						<h3 className='font-matter text-lg font-semibold text-brand-base'>Teach Agents to Navigate Software</h3>
						<p className='text-sm text-brand-base/80'>
					...
					<div className='flex flex-col gap-4 rounded-2xl border border-brand-neutral-300 bg-white p-6 shadow-sm'>
						<h3 className='font-matter text-lg font-semibold text-brand-base'>Simulate Computer-Use Workflows</h3>
						<p className='text-sm text-brand-base/80'>
					...
					<div className='flex flex-col gap-4 rounded-2xl border border-brand-neutral-300 bg-white p-6 shadow-sm'>
						<h3 className='font-matter text-lg font-semibold text-brand-base'>Run Task-Level Evaluations</h3>
						<p className='text-sm text-brand-base/80'>

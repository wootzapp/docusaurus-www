		...
		<section className='bg-white py-24 text-brand-base' id='example-environment'>
			<div className='container-custom flex flex-col gap-12'>
				<div className='grid gap-8 lg:grid-cols-2'>
					<div className='flex flex-col gap-6 rounded-2xl border border-brand-neutral-300 bg-brand-neutral-100 p-8 shadow-sm shadow-brand-base/5'>
					...
					<div className='flex flex-col gap-4 rounded-2xl border border-brand-neutral-300 bg-brand-neutral-100 p-8 shadow-sm shadow-brand-base/5'>
						<div className='grid gap-4 sm:grid-cols-2'>
							{tailoredValue.map((item) => (
								<div key={item.head} className='flex h-full flex-col gap-2 rounded-xl border border-brand-neutral-200 bg-white/90 p-5 text-left shadow-sm shadow-brand-base/5'>
									<h3 className='font-matter text-base font-semibold text-brand-base'>
										{item.head}
									</h3>
